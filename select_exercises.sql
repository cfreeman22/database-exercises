...
SELECT * FROM albums 
WHERE release_date = 1990; -- Album release in the 1990 was The immaculate collection by Madonna
...
The Wall */
 ...
 SELECT *  FROM albums 
 Where genre like'%Rock%' OR genre like '%rock%'; -- We have to use the '%' to display all the other types of rocks 
